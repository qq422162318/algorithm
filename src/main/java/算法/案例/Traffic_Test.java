...
public class Traffic_Test {
    public static void main(String[] args) throws Exception{
        ...
        BufferedReader br = new BufferedReader(new InputStreamReader(Traffic_Test.class.getClassLoader().getResourceAsStream("算法/案例/traffic_project.txt")));
